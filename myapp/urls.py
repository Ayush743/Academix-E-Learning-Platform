...
from .views import signup,login_view,student_main,teacher_main,registrar_main,admin_dashboard,admin_announcement,admin_live,student_management,teacher_management,course_management,add_teacher,view_teacher,upload_csv,delete_teacher
urlpatterns = [
